...
async function subject() {
  ...
  await repo.withLock((store) => {
    ...
    store.enrollments.push({ agentUuid: 'agent_1', deviceCode: 'device_1', principalId: 'principal_1', status: 'bound', publicJwk: { kty: 'EC', crv: 'P-256', x: 'x', y: 'y' }, thumbprint: 'thumbprint', keystoreProvider: 'os_hardware', agentUriPath: '/agents/agent_1', createdAt: now.toISOString(), updatedAt: now.toISOString() });
